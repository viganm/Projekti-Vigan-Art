...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylesheetResetPassword.css">
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            ...
            <div class="form-group">
                <input type="submit" class="buttonatcancel" value="Submit"><br><br>
                <a class="buttonatcancel" href="welcome.php">Cancel</a>
            </div>
        </form>
    </div>    
</body>
